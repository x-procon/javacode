 ...
 */
@Configuration
@MapperScan(basePackages = "cc.procon.mapper.dm",
        sqlSessionFactoryRef =  "dmSqlSessionFactory")
public class DmDataSourceConfig {
    @Value("${mybatis.dm.mapper-locations}")
    private String mapperLocations;

    @Value(value = "${spring.datasource.dm.url}")
    private String dbUrl;
    @Value(value = "${spring.datasource.dm.username}")
    private String username;
    @Value(value = "${spring.datasource.dm.password}")
    private String password;
    @Value(value = "${spring.datasource.dm.driver-class-name}")
    ...
    public SqlSessionFactory dmSqlSessionFactory(@Qualifier("dmDataSource") DataSource dataSource)
            throws Exception {
    ...
    public SqlSessionTemplate dmSqlSessionTemplate(
            @Qualifier("dmSqlSessionFactory") SqlSessionFactory sqlSessionFactory) {
